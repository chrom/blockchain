...
abstract contract Animal is Living {
    ...
    function eat(string memory food) pure public NutritionCheck(food) returns (string memory){
    ...
    modifier NutritionCheck(string memory food) virtual {
        _;
    }
}
...
abstract contract Herbivore is Animal, HasName {
    ...
    modifier NutritionCheck (string memory food) override {
